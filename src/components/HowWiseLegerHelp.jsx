  ...
  return (
    <div>
        <div className='primary-back pt-28'>
            <h6 className='text-center text-4xl font-semibold nav-text text-red  mx-0 md:mx-56 mb-20 font-sans'>The Easiest way to manage your business finances from your phone</h6>
            ...
            <div>
                <div className=' flex-1 md:flex align-center justify-center gap-5 mx-12'>
                    <img src={PersonOperating} alt="person with phone"/>
                     <div>
                        ...
                        <p className='text-2xl font-semibold secondary-text-color max-w-fit w-96 font-sans mt-6'>Sales management with WiseLedger is very easy. In a few clicks, you can record sales, check out sales history and get up-to-date inventory record. Suitable for both online and offline businesses.</p>
                ...
                <div className=' flex-1 md:flex justify-center align-center md:mx-20 mx-10 md:gap-5'>
                  <div className='md:mt-52 mt-20'>
                    ...
                    <p className='  secondary-text-color text-2xl max-w-fit'>Avoid bad debt, get paid on time. Create, customise and send invoice in a click. WiseLedger is here to make it happen.</p>
