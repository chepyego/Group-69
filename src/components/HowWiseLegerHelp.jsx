  ...
  return (
    <div>
        <div className='primary-back pt-28'>
            <h6 className='text-center text-xl md:text-4xl font-semibold nav-text text-red mx-0 md:mx-56 md:mb-20 mb-6 font-sans'>The Easiest way to manage your business finances from your phone</h6>
