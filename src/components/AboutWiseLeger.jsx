    ...
    <div>
      <div>
        <div className='text-center text-4xl font-semibold nav-text mt-36 mb-11'>What you can do with wise Ledger</div>
          ...
          <div className='md:ml-48 md:mr-40 ml-0 mr-0  block  md:flex justify-center flex-wrap p-8 md:p-0 gap-2'>
            <div className=' hover:bg-gray-100 shadow-2xl bg-white rounded-2xl w-96   max-h-fit md:mx-auto  mb-28'>
              ...
              <button onClick={moreClick} className=' my-4 nav-button rounded-lg text-white py-2.5 px-8 '>{showMore ? "Read less": "Learn More"}
              </button>
             </p> 
            </div>
            <div className='hover:bg-gray-100 shadow-2xl bg-white rounded-2xl w-96 max-h-fit mx-auto mb-28'>
